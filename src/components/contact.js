        ...
        <div>
            ...
            <div className='relative'>
                 ...
                 <div className='absolute top-0 bg-blue-900 w-full h-full bg-opacity-60 text-center justify-center '>
                     ...
                     <p className='absolute  h-1/3 text-center w-full text-8xl text-gray-50 font-semibold justify-center uppercase'>CONTACT</p>
                 </div>
             </div>
          <div className='w-2/3'>
          <p className='font-header mt-12 font-semibold text-6xl text-gray-700'>Talk to us!</p>
